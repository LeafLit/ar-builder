...
- 当前最新提交：`a674c63 feat: manage local projects`
- 防缓存测试地址：`https://leaflit.github.io/ar-builder/?v=a674c63`
...
1. 增加采集样本管理：查看样本、删除坏样本、补采样本。
2. 增加训练样本质量提示：光线、背景、角度、每个状态建议样本数。
