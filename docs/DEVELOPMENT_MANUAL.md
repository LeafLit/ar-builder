...
- 采集页已支持基础样本管理：查看样本缩略图、删除坏样本、删除后同步数量，并继续补采。
- 当前尚未完成 WebXR 空间 AR、状态切换过渡动画、样本质量提示、单张重拍、项目导入/导出和云同步。
- 最新自动检查通过并已推送的功能提交：`766e9a9 feat: manage captured samples`。其中“采集样本管理”仍需继续真机验证。
